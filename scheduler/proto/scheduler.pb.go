...
func file_scheduler_proto_scheduler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_scheduler_proto_scheduler_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_scheduler_proto_scheduler_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_scheduler_proto_scheduler_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Spec); i {
			case 0:
				return &v.state
			case 1:
		...
		file_scheduler_proto_scheduler_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
		...
		file_scheduler_proto_scheduler_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_scheduler_proto_scheduler_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_scheduler_proto_scheduler_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Label); i {
			case 0:
				return &v.state
			case 1:
		...
		file_scheduler_proto_scheduler_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_scheduler_proto_scheduler_proto_msgTypes[8].Exporter = func(v any, i int) any {
