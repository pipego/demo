...
func (c *serverProtoClient) SendTask(ctx context.Context, opts ...grpc.CallOption) (ServerProto_SendTaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServerProto_ServiceDesc.Streams[0], ServerProto_SendTask_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &serverProtoSendTaskClient{stream}
	return x, nil
}
...
func (c *serverProtoClient) SendGlance(ctx context.Context, opts ...grpc.CallOption) (ServerProto_SendGlanceClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServerProto_ServiceDesc.Streams[1], ServerProto_SendGlance_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &serverProtoSendGlanceClient{stream}
	return x, nil
}
...
func (c *serverProtoClient) SendMaint(ctx context.Context, opts ...grpc.CallOption) (ServerProto_SendMaintClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServerProto_ServiceDesc.Streams[2], ServerProto_SendMaint_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &serverProtoSendMaintClient{stream}
	return x, nil
}
...
func _ServerProto_SendTask_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ServerProtoServer).SendTask(&serverProtoSendTaskServer{stream})
}
...
func _ServerProto_SendGlance_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ServerProtoServer).SendGlance(&serverProtoSendGlanceServer{stream})
}
...
func _ServerProto_SendMaint_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ServerProtoServer).SendMaint(&serverProtoSendMaintServer{stream})
}
