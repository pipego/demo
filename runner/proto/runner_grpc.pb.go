...
const (
	ServerProto_SendServer_FullMethodName = "/runner.ServerProto/SendServer"
)
...
func (c *serverProtoClient) SendServer(ctx context.Context, opts ...grpc.CallOption) (ServerProto_SendServerClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServerProto_ServiceDesc.Streams[0], ServerProto_SendServer_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
